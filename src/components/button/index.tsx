    ...
    return (
      <button
        className={qtMerge(
          ...
          variant === 'secondary' && colorStyle !== 'white' && 'border-75',
          variant === 'secondary' &&
            colorStyle === 'coral' &&
          ...
          size === 'sm' && 'rounded-400 p-400 text-50',
          size === 'md' && 'rounded-600 p-600 text-75',
          size === 'lg' && 'rounded-800 p-800 text-100',
          size === 'xl' && 'rounded-1200 p-1200 text-300',
          ...
          variant === 'tertiary' &&
            colorStyle === 'coral' && ['text-solid-coral-700'],

          variant === 'tertiary' &&
            colorStyle === 'black' && ['text-solid-slate-1400'],

          variant === 'tertiary' &&
            colorStyle === 'white' && ['text-solid-slate-50'],
